...
public class AdminOrderServiceImpl implements AdminOrderService {
        ...
        @Override
        public Page<AdminOrderSummaryResponse> getOrders(int page, int size, OrderStatus statusEnum, String keyword) {
        ...
        public AdminOrderDetailResponse getOrderById(String orderId) {
                ...
                AdminOrderDetailResponse.AdminAddressInfo addressInfo = AdminOrderDetailResponse.AdminAddressInfo
                                .builder()
